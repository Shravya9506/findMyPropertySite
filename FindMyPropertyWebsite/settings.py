...
INSTALLED_APPS = [
    ...
    'findMyProperty.apps.FindMyPropertyConfig'
]
...
ROOT_URLCONF = 'FindMyPropertyWebsite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'users/templates'),os.path.join(BASE_DIR, 'findMyProperty/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'FindMyPropertyWebsite.wsgi.application'
